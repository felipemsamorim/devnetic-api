	...
	<div class="container-fluid">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 margem ">
			<div class="vazio">
				...
				<p>Seu cadastro está quase pronto.<br>
					Para ativa-lo clicando  <a href="http://127.0.0.1:8080/#!/active/{{active}}"> aqui </a>
					<p> <strong><i> Equipe iBoltt. </i> </strong></p>
				</div>
			</div>
		</div>

		<div class="container-fluid foolter barra-horizontal"> </div> 		
	</body>
	</html>`)
